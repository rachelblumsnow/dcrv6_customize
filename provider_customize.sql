...
//create secure view 
create or replace secure view "DCR_DEMOCUR_PROVIDER_DB"."SHARED_SCHEMA"."PROVIDER_PUBLISHER_V" as select * from "DCR_DEMOCUR_PROVIDER_DB"."SHARED_SCHEMA"."PUBLISHER_CUSTOMER";
create or replace secure view "DCR_DEMOCUR_PROVIDER_DB"."CLEANROOM"."PROVIDER_PUBLISHER_V" as select * from "DCR_DEMOCUR_PROVIDER_DB"."SHARED_SCHEMA"."PUBLISHER_CUSTOMER";

//apply row access policy
ALTER TABLE  "DCR_DEMOCUR_PROVIDER_DB"."CLEANROOM"."PROVIDER_PUBLISHER_V" add row access policy dcr_DEMOCUR_provider_db.shared_schema.data_firewall on (email);

//grant select on secure view to share
grant select on "DCR_DEMOCUR_PROVIDER_DB"."CLEANROOM"."PROVIDER_PUBLISHER_V" to share dcr_DEMOCUR_data;
grant select on "DCR_DEMOCUR_PROVIDER_DB"."SHARED_SCHEMA"."PROVIDER_PUBLISHER_V" to share dcr_DEMOCUR_app; 
...
from
    shared_schema.provider_publisher_v p,
