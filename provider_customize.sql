...
grant select on "DCR_DEMOCUR_PROVIDER_DB"."SHARED_SCHEMA"."PROVIDER_PUBLISHER" to share dcr_DEMOCUR_data;
...
insert into dcr_DEMOCUR_provider_db.templates.dcr_templates (template_name, template, dp_sensitivity, dimensions, template_type, procedure_header) 
...
$$,1,'c.country|c.marital|c.equipment_like|c.activity_like|c.age_range|c.state|c.lifestyle_like|c.gender|p.genre|p.bundle_user|p.subscription_type|p.product_name','SQL_immediate',NULL);
